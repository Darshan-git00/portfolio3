          ...
          {skills.map((skill, i) => (
            ...
            >
              ...
              >
                ...
                <motion.span 
                  className="text-[10px] font-mono uppercase tracking-wider text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity duration-300 absolute -bottom-6 whitespace-nowrap"
                >
                  {skill.name}
                </motion.span>
              </motion.div>
